...
/**
 * AgentChatPanel.vue - Agent 对话测试面板 (V3)
 *
 * 对照 V1 AgentChatPanel.ts (426行) + V2 AgentChatPanel.vue (555行)
 *
 * Props:
 *   visible: boolean
  ...
  <div class="agent-chat-panel">
    ...
    <div class="chat-header">
      ...
      <div class="header-right">
        <div class="character-name">{{ characterName || '新角色' }}</div>
        <div class="character-type">AI Agent</div>
      </div>
    </div>
