...
export class TokenManager {
  private modelLimits: Map<string, TokenLimit> = new Map([
    ...
    ['gpt-4o-mini', { maxTokens: 128000, reservedForResponse: 4096 }],
    ['gpt-3.5-turbo', { maxTokens: 16385, reservedForResponse: 2048 }],
    ['claude-3-opus-20240229', { maxTokens: 200000, reservedForResponse: 4096 }],
    ['claude-3-sonnet-20240229', { maxTokens: 200000, reservedForResponse: 4096 }],
    ['claude-3-haiku-20240307', { maxTokens: 200000, reservedForResponse: 4096 }],
    ...
    ['qwen-turbo', { maxTokens: 32768, reservedForResponse: 4096 }],
